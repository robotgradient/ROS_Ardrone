...
void FiboCallback(const intros_action_example::fibonacciGoalConstPtr &goal,
        actionlib::SimpleActionServer<intros_action_example::fibonacciAction>* as)
{
    ...
    ROS_INFO("Fibonacci action: Executing, creating fibonacci sequence of order %i with seeds %i, %i",
